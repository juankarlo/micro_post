...
describe User do
  ...
  describe 'When email format is invalid' do
    it 'should be invalid' do
      addresses = %w[ user.@foo.com user@foo,com user_at_foo.org
example.user@foo. foo@bar_baz.com foo@bar+baz.com foo@bar..com ]
  ...
  describe "When password confirmation isn't present" do
    before do
      @user = User.new(name: 'Example User', email: 'user@example.com',
  ...
  describe 'Micropost association' do
    ...
    # This test fulfill the test of the dependent: destroy clause
    ...
    describe "Status" do
      ...
      before do
        ...
        3.times { followed_user.microposts.create!(
            content: "Where is the clear gibbet?")}
      end
